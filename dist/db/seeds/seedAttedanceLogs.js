...
export const seedAttendanceLogs = async () => {
    ...
    const dummyLogs = [
        ...
        {
            employeeId: sampleEmployeeId,
            attendanceDate: '2026-07-21', // Hari Selasa (Terlambat)
        ...
        {
            employeeId: sampleEmployeeId,
            attendanceDate: '2026-07-22', // Hari Rabu (Aktif / Belum Check-Out)
    ...
    try {
        ...
        console.error('❌ Gagal melakukan seed attendance logs:', error);
    }
};
// Jalankan jika file dipanggil langsung
seedAttendanceLogs();
//# sourceMappingURL=seedAttedanceLogs.js.map