...
export async function createDepartments(req, res, next) {
    try {
...
export async function updateDepartments(req, res, next) {
    try {
        const id = Number(req.params.id);
        if (Number.isNaN(id)) {
            return next({
...
export async function removeDepartments(req, res, next) {
    try {
        const id = Number(req.params.id);
        if (Number.isNaN(id)) {
            return next({
