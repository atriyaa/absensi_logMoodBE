...
export async function getAllRoles(_req, res, next) {
    try {
...
export async function createRoles(req, res, next) {
    try {
...
export async function updateRoles(req, res, next) {
    try {
        const id = Number(req.params.id);
        if (Number.isNaN(id)) {
            return next({
...
export async function removeRoles(req, res, next) {
    try {
        const id = Number(req.params.id);
        if (Number.isNaN(id)) {
            return next({
